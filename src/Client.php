...
class Client {
    ...
    static public function RegisterClient($newFirstName, $newLastName, $newEmail, $password1, $password2, $newAddress){
        ...
        $sql = "INSERT INTO Clients(first_name, last_name, email, password, address)
                VALUES ('$newFirstName', '$newLastName', '$newEmail', '$hashedPassword', '$newAddress')";
    ...
    static public function LogInClient($email, $password){
        ...
        $result = Client::$connection->query($sql);
        if($result !== FALSE) {
